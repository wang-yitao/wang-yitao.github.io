...
However, as a control freak and a nerd who loves elegant and neat solutions to every problem, and likes to present (~~show off~~) their coding skills, the GUI options are not an option and having a static and minimalist [jekll](https://jekyllrb.com/) website as a platform to showcase the work and idea is almost **the default and most professional choice**. (You see simply google how other programmers, engineers, and scientists build their sites.)
